    ...
    return Scaffold(
      bottomSheet: Container(
        ...
        child: appButton(
            ...
            voidCallback: () {
              Get.toNamed(AppRoutes.bookingDateTimeView, arguments: [
                data,
              ]);
            },
            widget: Row(
              ...
              children: [
                ...
                appText(
                    text: 'Book Now', fontSize: SizeConfig.textMultiplier * 2.0)
              ],
            )),
      ),
      body: ListView(
              ...
              children: [
                ...
                ticketDetailTile(
                  ...
                  selectedDurationIndex:
                      categoriesDetailVM.selectedDurationIndex,
                  noOfPerson: '4',
                  itemCount: '02',
                  title: data.title,
                  ...
                  itemDetailCallBack: () {
                    print('object');
                    Get.toNamed(AppRoutes.categoryItemDetailView,
                        arguments: [data, modelList]);
                  },
                  increamentCallback: () {},
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(data.galleryPhotoUrls[index]),
                            fit: BoxFit.cover)),
                  );
                }),
          ),
          data.whatToExpect.isEmpty
                    ...
                    children: [
                      ...
                      Column(
                        children: List.generate(
                            ...
                            (index) => expectionTile(
                                check: data.whatToExpect[index].available,
                                title: data.whatToExpect[index].feature)),
                      ),
                      SizedBox(
                        height: SizeConfig.heightMultiplier * 3.0,
                      ),
                  ...
                  for (int i = 0; i < dataofModelList.slots.length; i++) {
                    return Container(
                      ...
                      child: categoriesTile(
                          isFavoriteCallback: () {},
                          isFavorite: dataofModelList.isLiked,
                          discount: dataofModelList
                              .slots[i].discount.discountPercentage
                              .toString(),
                          ratingCallback: (value) {},
                          initialRating: 3,
                          title: dataofModelList.title,
                          subtitle: dataofModelList.location.title,
                          location: dataofModelList.location.streetAddress,
                          price: dataofModelList.slots[i].price.toString(),
                          imageUrl: dataofModelList.photoUrl,
                          categoriesCallback: () {}),
                    );
                  }
                }),
      ...
      floatingActionButton: GestureDetector(
          ...
          child: Padding(
            ...
            child: Image(
              image: const AssetImage('assets/category/chatbutton.png'),
              fit: BoxFit.cover,
              height: SizeConfig.heightMultiplier * 10,
